...
import { AgentToolRouter } from '../../shared-core';
...
const WRITE_OR_EXEC_TYPES = new Set<AgentAction['type']>([
...
const SUBAGENT_DENIED_TYPES = new Set<AgentAction['type']>([...WRITE_OR_EXEC_TYPES, 'delegate_task', 'propose_plan', 'todo_write']);
...
export class AgentToolRegistry {
  ...
  constructor(
    ...
    private readonly pathOperations: PathOperationService
  ) {
