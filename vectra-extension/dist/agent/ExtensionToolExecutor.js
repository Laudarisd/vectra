...
exports.ExtensionToolExecutor = void 0;
...
class ExtensionToolExecutor {
    ...
    constructor(workspace, patches, commands, git, todos, plans, web, pathOperations) {
        ...
        this.router = new agent_core_1.AgentToolRouter((action) => action.type)
    ...
    describe(action) {
        ...
        return (0, agent_core_1.describeVectraTool)(action.type, action);
    }
    ...
    async executeTrusted(action, context) {
        if (context.subagent && agent_core_1.VECTRA_SUBAGENT_DENIED_TOOL_NAMES.has(action.type)) {
        ...
        if (context.mode === 'agent' && agent_core_1.VECTRA_WRITE_OR_EXECUTE_TOOL_NAMES.has(action.type) && this.planBlocksWrites()) {
...
exports.ExtensionToolExecutor = ExtensionToolExecutor;
...
//# sourceMappingURL=ExtensionToolExecutor.js.map