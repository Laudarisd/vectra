...
const ContextCollector_1 = require("./workspace/ContextCollector");
const DiffContentProvider_1 = require("./workspace/DiffContentProvider");
const EditProposalManager_1 = require("./workspace/EditProposalManager");
const PlanManager_1 = require("./state/PlanManager");
const TodoManager_1 = require("./state/TodoManager");
const LocalCredentialStore_1 = require("./providers/LocalCredentialStore");
const LlamaCppRuntime_1 = require("./runtime/llama/LlamaCppRuntime");
const WorkspaceTools_1 = require("./workspace/WorkspaceTools");
const CommandRunner_1 = require("./workspace/CommandRunner");
const AttachmentService_1 = require("./documents/AttachmentService");
...
function activateVectra(context, output) {
    ...
    localLlama = new LlamaCppRuntime_1.LlamaCppRuntime();
    ...
    const patches = new EditProposalManager_1.EditProposalManager(tools);
