...
exports.LlamaCppRuntime = void 0;
...
const HuggingFaceSearch_1 = require("../../models/HuggingFaceSearch");
const LocalModelDiscovery_1 = require("../../models/LocalModelDiscovery");
const LlamaCppInstaller_1 = require("./LlamaCppInstaller");
const ModelCatalog_1 = require("../../models/ModelCatalog");
const ModelDownloader_1 = require("../../models/ModelDownloader");
const ModelRecommender_1 = require("../../models/ModelRecommender");
...
class LlamaCppRuntime {
    ...
    async detectAndSelectModel() {
        ...
        }, () => (0, LocalModelDiscovery_1.discoverInstalledModels)({ extraRoots, ollamaBaseUrl: config.ollamaBaseUrl }));
        ...
        if (!detected.length) {
            const fallback = await vscode.window.showWarningMessage('Vectra did not find a GGUF file, installed Ollama model, or supported running local model server.', 'Choose folder to scan', 'Choose GGUF file');
...
exports.LlamaCppRuntime = LlamaCppRuntime;
...
//# sourceMappingURL=LlamaCppRuntime.js.map