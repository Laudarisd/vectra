...
class CommandRunner {
    ...
    async run(command, cwdInput = '', timeoutMs = 120_000, reason = '', kind = 'command', signal) {
    ...
    async runFile(pathInput, args = [], timeoutMs = 120_000, reason = '', signal) {
    ...
    async runProject(pathInput = '', timeoutMs = 180_000, reason = '', signal) {
    ...
    async runTestsAuto(cwdInput = '', timeoutMs = 180_000, reason = '', signal) {
        const cwd = this.resolveCwd(cwdInput);
        const detection = await detectProject(cwd);
